...
data "archive_file" "lambda_get_zip" {
  type        = "zip"
  source_file = "../python/src/return_count/lambda_get_visitor_count.py"
  output_path = "../lambda_get_visitor_count.zip"
}

data "archive_file" "lambda_increment_zip" {
  type        = "zip"
  source_file = "../python/src/increment_count/lambda_increment_visitor_count.py"
